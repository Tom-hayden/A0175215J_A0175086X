...
dataProcessOptions.preprocessing = 'all'; %valid values are 'none' and 'all'
dataProcessOptions.augmentation = 'none';  %valid values are 'none', 'mirror' and 'all'
...
[Data_CNN, Labels_CNN, Test_CNN] = dataReshapeCNN(Data_cpy, Labels_cpy, test_cpy);
