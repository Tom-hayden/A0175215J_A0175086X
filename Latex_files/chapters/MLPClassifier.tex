...
There are many improvements which could improve the accuracy of our MLP classifier. Perhaps the simplest of these is to use more data augmentation. For our final model we only used horizontal mirroring
